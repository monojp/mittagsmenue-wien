...
function build_response($lat_orig, $lng_orig, $api_response) {
	...
	foreach ((array)$api_response as $result) {
		...
		$name = trim(str_replace([ 'Little Stage', 'WerkzeugH', 'Osteria Vinoteca Panarea',
			...
			'TIP TOP TABLE GmbH', 'Cafe Jelinek', 'Pizzeria Tanti Saluti', 'Bangkok Vienna', 'Lidl',
			...
			'Zum lieben Augustin', 'Beweg-bar-catering GmbH', 'Il Cantuccino', 'Eissalon Valentino',
			'Orient Marketingservice Gesellschaft m.b.H. Nfg. KG', 'BIO Bezirksimkerei Wien',
			'Lorenz Hauser', 'Eduscho (Austria) GmbH', 'Mokador espresso italiano', 'Firat GesmbH',
			'SchwedendelikatEssen', 'NEUSTART - Bewährungshilfe, Konfliktregelung, Soziale Arbeit',
			'Ristorante Mariarosa', 'Yasar Vural KG', 'PENNY Markt', 'ALAS Restaurant', 'Mi Barrio',
