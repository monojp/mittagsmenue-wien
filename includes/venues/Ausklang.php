...
class Ausklang extends FoodGetterVenue {
	...
	protected function get_today_variants() {
		return [
			mb_strtolower(getGermanDayName()) . ', ' . date('d.', $this->timestamp) . ' ' . mb_strtolower(getGermanMonthName()),
		];
	}
	...
	protected function parseDataSource() {
		...
		$data = $this->parse_foods_inbetween_days($dataTmp, getGermanDayName(1), 'menü');
